...
describe('Environment routing resolve service', () => {
  ...
  let resultEnvironment: IEnvironment | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEnvironment).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEnvironment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
