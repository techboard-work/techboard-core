...
type ActivityFormDefaults = Pick<NewActivity, 'id' | 'startedOn' | 'finishedOn' | 'impediment'>;
...
type ActivityFormGroupContent = {
  ...
  impediment: FormControl<ActivityFormRawValue['impediment']>;
  employee: FormControl<ActivityFormRawValue['employee']>;
...
export class ActivityFormService {
  createActivityFormGroup(activity: ActivityFormGroupInput = { id: null }): ActivityFormGroup {
    ...
    return new FormGroup<ActivityFormGroupContent>({
      ...
      impediment: new FormControl(activityRawValue.impediment),
      employee: new FormControl(activityRawValue.employee),
