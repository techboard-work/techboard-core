...
import work.techboard.core.config.ApplicationProperties
import work.techboard.core.config.CRLFLogConverter
...
class TechboardApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes techboard.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<TechboardApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(TechboardApp::class.java)
