...
describe('Tag e2e test', () => {
  ...
  describe('new Tag page', () => {
    ...
    it('should create an instance of Tag', () => {
      ...
      cy.get(`[data-cy="order"]`).type('8749').should('have.value', '8749');
      ...
      cy.get(`[data-cy="description"]`).type('Identity').should('have.value', 'Identity');

      cy.get(`[data-cy="icon"]`).type('Security Product').should('have.value', 'Security Product');

      cy.get(`[data-cy="link"]`).type('compress Market').should('have.value', 'compress Market');
