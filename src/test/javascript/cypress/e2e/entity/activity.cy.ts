...
describe('Activity e2e test', () => {
  ...
  const activitySample = { name: 'pricing sensor Bedfordshire', startedOn: '2023-03-16T20:29:01.065Z' };
  ...
  describe('new Activity page', () => {
    ...
    it('should create an instance of Activity', () => {
      ...
      cy.get(`[data-cy="startedOn"]`).type('2023-03-17T11:12').blur().should('have.value', '2023-03-17T11:12');

      cy.get(`[data-cy="finishedOn"]`).type('2023-03-17T08:16').blur().should('have.value', '2023-03-17T08:16');
