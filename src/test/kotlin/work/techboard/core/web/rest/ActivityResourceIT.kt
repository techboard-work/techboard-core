...
class ActivityResourceIT {
    ...
    fun createActivity() {
        ...
        assertThat(testActivity.impediment).isEqualTo(DEFAULT_IMPEDIMENT)
    }
    ...
    fun getAllActivities() {
        ...
        restActivityMockMvc.perform(get(ENTITY_API_URL+ "?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].impediment").value(hasItem(DEFAULT_IMPEDIMENT)))    }
    ...
    fun getActivity() {
        ...
        restActivityMockMvc.perform(get(ENTITY_API_URL_ID, activity.id))
            ...
            .andExpect(jsonPath("$.impediment").value(DEFAULT_IMPEDIMENT))    }
    @Test
    @Transactional
    @Throws(Exception::class)
    ...
    fun putExistingActivity() {
        ...
        updatedActivity.impediment = UPDATED_IMPEDIMENT
        ...
        assertThat(testActivity.impediment).isEqualTo(UPDATED_IMPEDIMENT)
    }
...
val testActivity = activityList.last()
    ...
    companion object {
        ...
        private const val DEFAULT_IMPEDIMENT: Boolean = false
        private const val UPDATED_IMPEDIMENT: Boolean = true
